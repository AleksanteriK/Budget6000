...
function Signup() {
    ...
    values: {
        ...
        {
            toast.error("Anna käyttäjätunnus, salasana, etu- ja sukunimi sekä sähköposti!");
            return;
        }
        ...
        <div>
            ...
            >
                <Form className="form-group">
                    ...
                    <Field id="username" name="username" placeholder="Käyttäjänimi" className="form-control" />
                    ...
                    <label htmlFor="phone">Puhelinnumero (Ei pakollinen)</label>
